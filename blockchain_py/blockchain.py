...
class Blockchain(object):
    ...
    def register_node(self, address):
        """
            Add a new node to the list node
    ...
    def resolve_conflicts(self):
        """
            This is Consensus Algorithm, it resolve conflicts
    ...
    def proof_of_work(self, last_proof):
        """
            Simple Proof of Work Algorithm:
                - Find p' and p, p is previous proof and p' is new proof
    ...
    def valid_proof(last_proof, proof):
        ...
        guess = str('{}{}'.format(last_proof, proof)).encode()
...
def mine():
    # run the proof of work algorithm with the last proof 
